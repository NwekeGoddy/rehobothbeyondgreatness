...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="w-11/12 flex gap-4 flex-row items-center">
        ...
        <div className="flex flex-col items-left w-1/2 my-8">
          <h1 className="text-left mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
